...
var _fetchImagesJs = require("./fetchImages.js");
...
function onSearchForm(e) {
    ...
    (0, _fetchImagesJs.fetchImages)(query, page, perPage).then((data)=>{
        if (data.totalHits === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
...
function onLoadMore() {
    ...
    (0, _fetchImagesJs.fetchImages)(query, page, perPage).then((data)=>{
        ...
        if (page > totalPages) (0, _notiflixDefault.default).Notify.failure("We're sorry, but you've reached the end of search results.");
...
function showLoadMorePage() {
    if (checkIfEndOfPage()) onLoadMore();
}
...
},{"notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./fetchImages.js":"dOg5x","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"kaxSc":[function() {},{}],"dOg5x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchImages", ()=>fetchImages);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _apiKeyJs = require("./api-key.js");
//checking for the mistakes during request to the server
(0, _axiosDefault.default).defaults.baseURL = "https://pixabay.com/api/";
(0, _axiosDefault.default).interceptors.response.use((response)=>{
    return response;
}, (error)=>{
...
async function fetchImages(query, page, perPage) {
    const response = await (0, _axiosDefault.default).get(`?key=${(0, _apiKeyJs.KEY)}&q=${query}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
    return response.data;
}

},{"axios":"jo6P5","./api-key.js":"9d8Tu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9d8Tu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "KEY", ()=>KEY);
const KEY = "34187261-edb3bdfe414ee3b7adebeccc5";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bFOAz","dV6cC"], "dV6cC", "parcelRequired7c6")
