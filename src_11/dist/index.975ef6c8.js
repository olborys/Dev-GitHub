...
var _noImagePng = require("./image/no_image.png");
var _noImagePngDefault = parcelHelpers.interopDefault(_noImagePng);
const select = document.getElementById("breed-select");
const catInfo = document.querySelector(".cat-info");
const spinner = document.querySelector(".spinner");
const slimSelect = new (0, _slimSelectDefault.default)({
    select: select,
    settings: {
...
function displayCatInfo(catData) {
    ...
    <div class="wrapper">
      ...
      <div>
        ...
        <img src="https://flagsapi.com/${cat.country_code}/shiny/64.png" onerror="src='${0, _noImagePngDefault.default}'" width="64px" alt="country flag"> 
      </div>
    </div>
  `;
    showElement(catInfo);
...
async function handleBreedSelection() {
    try {
        ...
        hideElement(catInfo);
        showElement(spinner);
        const catData = await (0, _apiJs.fetchCatByBreed)(selectedBreedId);
        displayCatInfo(catData);
    } catch (error) {
        (0, _izitoastDefault.default).show(errorMessage);
    } finally{
        hideElement(spinner);
    }
}
async function initializeApp() {
    try {
        const breeds = await (0, _apiJs.fetchBreeds)();
...
},{"slim-select":"lzHUr","./js/api.js":"9u7qN","izitoast":"ftHqY","izitoast/dist/css/iziToast.min.css":"1MVRB","./image/no_image.png":"awspL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzHUr":[function(require,module,exports) {
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_7Q2AMZ6HDstEaY1G5FB7VFO74vE6ZgrdCQ13vI3CqKJ7fkennGGcUDAQV08Omeyv";
async function fetchBreeds() {
    return await (0, _axiosDefault.default).get("https://api.thecatapi.com/v1/breeds").then((response)=>response.data);
}
async function fetchCatByBreed(breedId) {
    return await (0, _axiosDefault.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`).then((response)=>response.data);
}
...
exports.default = isXHRAdapterSupported && function(config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
        ...
        if ((0, _indexJsDefault.default).hasStandardBrowserEnv) {
            ...
            const xsrfValue = (0, _isURLSameOriginJsDefault.default)(fullPath) && config.xsrfCookieName && (0, _cookiesJsDefault.default).read(config.xsrfCookieName);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ftHqY":[function(require,module,exports) {
var global = arguments[3];
/*
* iziToast | v1.4.0
...
*/ (function(root, factory) {
	 ...
	 */ var drag = function() {
        return {
            ...
            startMoving: function(toast, instance, settings, e1) {
                e1 = e1 || window.event;
                var posX1 = ACCEPTSTOUCH ? e1.touches[0].clientX : e1.clientX, toastLeft = toast.style.transform.replace("px)", "");
                toastLeft = toastLeft.replace("translateX(", "");
                var offsetX = posX1 - toastLeft;
	 ...
	 */ $iziToast.settings = function(options) {
        ...
        $iziToast.destroy();
        CONFIG = options;
        defaults1 = extend(defaults1, options || {});
    };
    /**
	 ...
	 */ $iziToast.show = function(options) {
        ...
        var settings = extend(CONFIG, options || {});
        settings = extend(defaults1, settings);
        settings.time = {};
...
},{}],"1MVRB":[function() {},{}],"awspL":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "no_image.71ba4683.png" + "?" + Date.now();
